...
@Slf4j
@Component
public class KafkaProduceImpl<K extends Serializable, V extends SpecificRecordBase> implements KafkaProducer<K,V> {
    private final KafkaTemplate<K, V> kafkaTemplate;

    public KafkaProduceImpl(KafkaTemplate<K, V> kafkaTemplate) {
