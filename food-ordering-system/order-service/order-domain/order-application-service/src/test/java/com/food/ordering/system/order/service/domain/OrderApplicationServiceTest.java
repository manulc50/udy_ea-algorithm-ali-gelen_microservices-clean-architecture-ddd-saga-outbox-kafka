...
class OrderApplicationServiceTest {
    final UUID CUSTOMER_ID = UUID.fromString("2b5d9a0b-f5d2-474f-ba92-7668bc89deea");
    final UUID RESTAURANT_ID = UUID.fromString("2b5d9a0b-f5d2-474f-ba92-7668bc89de45");
    final UUID PRODUCT_ID = UUID.fromString("2b5d9a0b-f5d2-474f-ba92-7668bc89de48");
    final UUID ORDER_ID = UUID.fromString("e8d68116-85de-4bd1-8949-37791731e447");
    ...
    void init() {
        ...
        when(customerRepository.findCustomer(new CustomerId(CUSTOMER_ID))).thenReturn(Optional.of(customer));
