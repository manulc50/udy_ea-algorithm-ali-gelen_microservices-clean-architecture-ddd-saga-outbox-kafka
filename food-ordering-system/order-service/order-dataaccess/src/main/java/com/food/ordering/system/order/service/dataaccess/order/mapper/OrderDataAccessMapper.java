...
public class OrderDataAccessMapper {
    ...
    public Order orderEntityToOrder(OrderEntity orderEntity) {
        return Order.builder()
                ...
                .failureMessages(orderEntity.getFailureMessages().isEmpty() ? new ArrayList<>()
                        // Nota: El método "asList" devuelve una lista inmutable. Si queremos que la lista sea mutable,
                        // tenemos que crear otra lista a partir de ella
    ...
    private StreetAddress addressEntityToDeliveryAddress(OrderAddressEntity orderAddressEntity) {
        return new StreetAddress(orderAddressEntity.getId(), orderAddressEntity.getStreet(),
